...
export function Contact() {
    return (
        <section id="pageContact" className="flex justify-center mt-20 p-10 flex-col-reverse md:flex-row items-center gap-16 md:gap-[15rem] md:h-[98vh]">
