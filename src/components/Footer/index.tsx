  ...
  return (
    ...
    <div className="mx-auto w-full flex flex-col md:flex-row max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
      <div className="grid grid-cols-1  gap-8 lg:grid-cols-3">
        <div>
          <h2 className="flex items-center justify-center font-bold h-10 w-32 rounded-lg bg-amber-700 ">Exclusividade</h2>
  
          <p className="mt-4  text-sm text-gray-50">
            Condomínios náuticos tem acessos privativos e exclusivos à água.
            Se você adquirir um terreno ou marina, além do acesso facilitado, você terá uma vista linda para a represa, da janela do seu quarto.
          </p>
      ...
      <div className="grid grid-cols-1 gap-8 mt-5 md:mt-0 sm:grid-cols-2 lg:col-span-2 lg:grid-cols-4">         
          ...
          <div>
            ...
            >
              ...
              <a className="hover:opacity-75" href="#"> Política de Privacidade </a>
              <a className="hover:opacity-75" href="#"> Termos e condições</a>
    ...
    <div className='mx-auto flex max-w-screen-xl pb-20 flex-col gap-5'>
      <p className="text-xs text-gray-50">&copy; 2022 Condomínio Náutico Protal do Sol</p>
